...
const salesareasRoutes = (app, fs) => {

    // variables
    const dataPath = './data/salesareas.json';
    ...
    // DELETE
    app.delete('/SalesAreas/:id', (req, res) => {
...
module.exports = salesareasRoutes;

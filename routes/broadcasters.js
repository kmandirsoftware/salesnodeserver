...
const broadcastersRoutes = (app, fs) => {

    // variables
    const dataPath = './data/broadcasters.json';
    ...
    // UPDATE
    app.put('/Broadcasters/:id', (req, res) => {
    ...
    // DELETE
    app.delete('/Broadcasters/:id', (req, res) => {
...
module.exports = broadcastersRoutes;

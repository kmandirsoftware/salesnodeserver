...
const programesRoutes = (app, fs) => {

    // variables
    const dataPath = './data/programes.json';
    ...
    // DELETE
    app.delete('/programes/:id', (req, res) => {
...
module.exports = programesRoutes;

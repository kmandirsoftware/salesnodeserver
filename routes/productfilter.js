...
const productfilterRoutes = (app, fs) => {

    // variables
    const dataPath = './data/productfilter.json';
    ...
    // CREATE
    app.post('/ProductFilter', (req, res) => {
    ...
    // UPDATE
    app.put('/ProductFilter/:id', (req, res) => {
    ...
    // DELETE
    app.delete('/ProductFilter/:id', (req, res) => {
...
module.exports = productfilterRoutes;
